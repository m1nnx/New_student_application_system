<?php
    ...
    if($filename != '')
    {
        ...
        $query = "update pendaftaran set trn_date= '$trn_date' ,PROGRAMME = '$programme',FACULTY = '$faculty',EDULEVEL = '$eduLevel',EDURESULT = '$filename',HOSTEL = '$hostel',INCOME = '$income' where IC = '$ic'";
        
        $query_run = mysqli_query($conn, $query);
        
        if($query_run){
            echo  '<script type = "text/javascript"> alert("Data Saved")</script>';
			echo "<script type='text/javascript'>window.top.location='stdupdate.php';</script>"; exit;
        }
        else{
