...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
  ...
  <ul class="navbar-nav ml-auto">
	...
	if($row==1){
	    ...
	    echo "<h2 align = center>EDIT/UPDATE APPLICANTS DETAILS</h2>";
	...
	?>
	<div >
	<form action="pendaftaranNew.php" method="post"><center><div id="table"><table align="center" width="60%">
	<tr><td width="50%" id="textAl">IC</td><td width="50%"><?php echo $IC;?></td></tr>
