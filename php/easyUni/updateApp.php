...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item active"><a class="nav-link" href="updateApp.php">LIST OF APPLICANTS</a></li>
  ...
  <ul class="navbar-nav ml-auto">
	...
	{?><center><div style="width:90%;font-size:14px;" class="font-weight-normal">
		...
		while($row = mysqli_fetch_assoc($result))
		{
			...
			<td><a href="editApp.php?IC=<?php echo $row['IC'];?>"><i class="fa fa-edit fa-fw " style="color:blue" alt="Edit"></i></a>
