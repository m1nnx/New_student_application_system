<?php
    ...
    if($filename != '')
    {
        ...
        $query = "INSERT INTO `rayuan`(`trn_date`,`IC`,`PROGRAMME`,`FACULTY`,`EDULEVEL`,`EDURESULT`,`HOSTEL`,`INCOME`)VALUES ('$trn_date','$ic','$programme','$faculty','$eduLevel','$filename','$hostel','$income')";
        
        $query_run = mysqli_query($conn, $query);
        
        if($query_run){
            echo  '<script type = "text/javascript"> alert("Data Saved")</script>';
			echo "<script type='text/javascript'>window.top.location='stdRayuan.php';</script>"; exit;
        }
        else{
